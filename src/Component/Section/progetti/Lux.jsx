      ...
      <div className="section-dettagli-center">
        ...
        <div className="section-dettagli-center-secondary">
          ...
          <div className="section-dettagli-aside">
            <p>
              Con Lux, il portfolio dell’artista prende vita online. Gli utenti
              possono scoprire e lasciarsi ispirare dalle opere, mentre
              l’artista gestisce tutto con facilità: carica, modifica ed elimina
              i lavori direttamente dalla propria dashboard, rendendo la
              creatività davvero a portata di clic.
            </p>
            <div className="section-dettagli-link">
              ...
              <a href="https://lucianofamoso.netlify.app/" target="_blank">
                LIVE APP
              </a>
            </div>
          </div>
